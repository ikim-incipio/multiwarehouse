...
class Aitoc_MultiLocationInventory_Block_Rewrite_AdminCatalogProductGrid extends Aitoc_Aitquantitymanager_Block_Rewrite_AdminCatalogProductGrid_Aittmp
{
    //override parent
        ...
        if ($warehouses){
            foreach ($warehouses as $warehouse){
                $collection->joinField('warehouse_' . $warehouse->getId(),
                    ...
                    'qty',
                    'product_id=entity_id',
                    '{{table}}.warehouse_id=' . $warehouse->getId(),
                    'left');
            }
        }
    ...
    protected function _prepareColumns()
    {
        ...
        if ($warehouses = Mage::getResourceModel('aitoc_multilocationinventory/warehouse_collection')){
                ...
                array(
                    ...
                    'filter'=> false,
                    'sortable' => false,
                    'renderer' => "Aitoc_MultiLocationInventory_Block_Adminhtml_Catalog_Product_Renderer",
            ));
        }
